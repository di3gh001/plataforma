...
export class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.crearRectangulo(700, 300);
        this.crearRectangulo(800, 300);
        this.crearRectangulo(900, 300);
        this.crearRectangulo(750, 200);
        this.crearRectangulo(850, 200);
        this.crearRectangulo(800, 100);
